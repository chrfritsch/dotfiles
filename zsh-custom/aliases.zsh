...
alias install-umami="drush si demo_umami --account-pass=admin --site-name=Drupal -y && drush-dev-init && drush cr --uri=http://drupal.local && drush uli --uri=http://drupal.local"
...
alias gbr='git branch | grep -v "^*" | xargs git branch -D'
